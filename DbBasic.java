...
public class DbBasic {
	...
	// There should be NO NEED for you to edit/change this class for this exercise
	
	// The only two methods you need are the constructor and the "close" database method.
	// The "Main.java" class calls them already.
	
	// In DbUser, you will need to access the Connection "con" and so it is declared as "protected" : can
	// be accessed in the inheriting class.
